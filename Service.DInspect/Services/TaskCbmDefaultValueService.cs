...
{
    public class TaskCbmDefaultValueService : ServiceBase
    {
        public TaskCbmDefaultValueService(MySetting appSetting, IConnectionFactory connectionFactory, string container, string accessToken) : base(appSetting, connectionFactory, container, accessToken)
        {
